(custom-set-variables
 ...
 '(safe-local-variable-values
   '((eval add-hook 'after-save-hook
      (lambda nil (org-export-to-file 'awesomecv "lejeune-vita.tex")) :append
      :local)
     (eval add-hook 'after-save-hook
      (lambda nil (org-export-to-file 'awesomecv "zamboni-vita.tex")) :append
      :local)
     (eval add-hook 'after-save-hook
      (lambda nil (org-export-to-file 'awesomecv "src/lejeune-vita.tex"))
      :append :local)
     (eval add-hook 'after-save-hook
      (lambda nil (org-export-to-file 'awesomecv "src/zamboni-vita.tex"))
      :append :local)
     (eval add-hook 'after-save-hook
      (lambda nil (org-export-to-file 'awesomecv "src/zamboni-resume.tex"))
      :append :local))))
(custom-set-faces
